...
class TakeAWaste:
    ...
    def forcasting(self, top_n_list: list) -> bool:
        ...
        for item in top_n_list:                     # loop over every unique product
            ...
            data_item_grouped = data_item.groupby([self.column_date])[self.column_quantity].sum()
            ...
            df_data_item_grouped.rename(columns={'Datum': 'ds', self.column_quantity: 'y'}, inplace=True)
